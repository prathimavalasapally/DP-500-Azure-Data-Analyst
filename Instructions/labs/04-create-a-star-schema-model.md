...
6. Complete the sign up process by providing username and password:

     * Email/Username: <inject key="AzureAdUserEmail"></inject>

     * Password: <inject key="AzureAdUserPassword"></inject>

7. You will be redirected to the Power BI sign-up page in Microsoft Edge. Select **contiune**.

   >**Note**: On the Welcome to Microsoft Edge page, select  **Start without your data**  and on the help for importing Google browsing data page, select 		      the **Continue without this data** button. Then, proceed to select  **Confirm and start browsing**  on the next page.

	![](../images1/dp-lab4-3.png)
	
8. If prompted **Signin** with following Username and Password.

    * Email/Username: <inject key="AzureAdUserEmail"></inject>

    * Password: <inject key="AzureAdUserPassword"></inject>
	
9. If stay signed in window Pops-up, select **No**

10. Select your **Country/Region (1)** and enter a 10 digit **phone number (2)** and select **Get started (3)**.

    ![](../images1/dp-lab4-(4).png)

11. Select **Get started** once more. You will be redirected to Power BI.

    ![](../images1/dp-lab4-5.png)

12. At the top-right, select the profile icon, and then select **Start trial**.

    ![](../images1/dp-lab4-(6).png)

13. When prompted, select **Start trial**.

    ![](../images1/dp-lab4-7.png)

14. Do any remaining tasks to complete the trial setup.

   >**Tip**: The Power BI web browser experience is known as the **Power BI service**.
	
15. Select Workspaces and **Create a Workspace**.
    
    ![](../images1/dp-lab4-8.png)

16. Create a workspace named **DP500-<inject key="Deployment ID" enableCopy="false" />** and select **Apply**.
...
17. Navigate back to Power BI Desktop. If you see **Sign in** in the top right corner of the screen, sign-in again using the credentials provided on the Resources tab of the lab environment. If you are already signed in, proceed to the next step.
...
18. Go to Power BI Desktop and select **File** then **Options and settings** then **Options** then **Security** and under Authentication Browser check **Use my default web browser** and select **OK**. Close Power BI Desktop. Do not save your file.
...
3. In the Azure portal, in the **Search resources, services, and docs** text box at the top of the Azure portal page, Search and select **Azure Synapse Analytics**
 
4. Select your Synapse workspace.

    ![](../images1/dp-lab4-10.png)

5. Scroll down on the Synapse workspace page, locate and select the dedicated SQL pool.

    ![](../images1/dp-lab4-11.png)

6. Resume the SQL pool.
...
2. On the home page of Azure Synapse Studio, select **Visualize** to link your Power BI workspace.

    ![](../images1/dp-lab4-14.png)

3. From the **Workspace name** dropdown, select the workspace you created in the previous task and select **Create**.

    ![](../images1/dp-lab4-15.png)

4. Navigate to **Manage (1)**, select **Publish all (2)** and then click on **Publish (3)** to ensure changes are published.
...
5. Select your SQL pool, **sqldb-<inject key="Deployment ID" enableCopy="false" />** **(1)**, and then select **Continue (2)**.
...
9. In the **Connection Settings** window, select the **DirectQuery (1)** option and click **OK (2)**.
...
10. In the **Power Query Editor** window, in the **Queries** pane (located at the left), notice there is one query for each table you checked.
...
11. Select the **DimDate** query.

    ![](../images1/dp-lab4-28.png)


12. In the **Query Settings** pane (located at the right), to rename the query, in the **Name** box, replace the text with **Date**, and then press **Enter**.

    ![](../images1/dp-lab4-29.png)


13. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

    ![](../images1/dp-lab4-29-1.png)

14. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

    ![](../images1/dp500-(32).png)


15. Check the following five columns and select **OK**.
...
16. In the **Query Settings** pane, in the **Applied Steps** list, notice that a step was added to remove other columns.
...
17. To rename the **FullDateAlternateKey** column, double-click the **FullDateAlternateKey** column header.

18. Replace the text with **Date**, and then press **Enter**.

    ![](../images1/dp-lab4-32.png)

19. Notice that a new applied step is added to the query.
...
21. To validate the query design, in the status bar (located along the bottom of the window), verify that the query has five columns.
...
22. In the **Applied Steps** pane, right-click the last step, and then select **View Native Query**.

    ![](../images1/dp-lab4-34.png)

23. In the **Native Query** window, review the SELECT statement that reflects the query design.
...
24. To close the **Native Query** window, select **OK**.

25. Select the **DimProductCategory** table. 
    
26. Rename the query to **Product Details**.

27. On the home tab of the ribbon, in the Combine group, select **Merge Queries.** 
...
28. Select the **DimProductSubcategory (1)** table from the drop down and select the **ProductCategoryKey (2)** Column in each table. Select **OK (1)**.

    ![](../images1/dp-lab4-35.png)

    >**Note**: Use the default join for this merge, which is a left outer join.

29. Expand the **DimProductSubcategory (1)** column. Select the **ProductSubcategoryKey (2)** and the **EnglishProductSubcategoryName (3)** columns. De-select **Use original column name as prefix (4)** and select **OK (6)**.
...
30. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

31. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

32. Check the following columns and click **ok**.
...
33.  Select the **DimProduct** query.

      ![](../images1/dp-lab4-37.png)

34. In the **Query Settings** pane (located at the right), to rename the query, in the **Name** box, replace the text with **Product**, and then press **Enter**.


35. On the home tab of the ribbon, in the Combine group, select **Merge Queries.** 

36. Select the **Product Details (1)** table from the drop down and select the **ProductSubcategoryKey (2)** column in both the Product table and the Product details table1 and select **OK (3)**.

     ![](../images1/dp-lab4-39.png)

37. Expand the Product Details column and select the **EnglishProductSubcategoryName** and the **EnglishProductCategoryName** columns. 

    ![](../images/dp500-45.png)

38. Select **OK**.

39.  To filter the query, in the **FinishedGoodsFlag (1)** column header, open the dropdown menu, uncheck **FALSE (2)** and Select **OK (3)**.

     ![](../images1/dp-lab4-41.png)
     
40. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

41. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

42. Check the following columns and click **ok**.
...
43. Rename the following columns:
...
44. In the **Applied Steps** pane, right-click the last step, and then select **View Native Query**.

45. In the **Native Query** window, review the SELECT statement that reflects the query design.

46. To close the **Native Query** window, select **OK**.

47. Verify that the query has five columns.

   >**Note**: The design of the **Product** query is now complete.

48. Select the **DimReseller** query.

49. Rename the query as **Reseller**.

50. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

51. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

52. Check the following columns and click **ok**.
...
57. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

58. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

59. Check the following columns and click **ok**.
...
60. Rename the following columns:
...
61. Verify that the query has four columns.

   >**Note**: The design of the **Territory** query is now complete.

62. Select the **FactResellerSales** query.

63. Rename the query as **Sales**.

64. To remove unnecessary columns, on the **Home** ribbon tab, from inside the **Manage Columns** group, select the **Choose Columns** icon.

65. In the **Choose Columns** window, to uncheck all checkboxes, uncheck the first checkbox.

66. Check the following columns and click **ok**.
...
67. Rename the following columns:

	- **OrderQuantity** as **Quantity**

	- **UnitPrice** as **Price**

68. To add a calculated column, on the **Add Column** ribbon tab, from inside the **General** group, select **Custom Column**.

    ![](../images1/dp-lab4-42.png)


69. In the **Custom Column** window, in the **New Column Name** box, replace the text with **Revenue**.

70. In the **Custom Column Formula** box, enter the following formula:
...
72. To modify the column data type, in the **Revenue** column header, select **ABC123**, and then select **Decimal Number**.

    ![](../images1/dp-lab4-43.png)

73. Review the native query, noticing the **Revenue** column calculation logic.

74. Verify that the query has seven columns.

   >**Note**: The design of the **Sales** query is now complete.

75. Right-click on the **Product Details** table and de-select **Enable load**. This will disable the load of the Product Details table to the data model, and it will not appear in the report.

    ![](../images1/dp-lab4-44.png)

76. Repeat this step, de-selecting Enable load, for the **DimProductSubcategory** table.

77. To apply the queries, on the **Home** ribbon tab, from inside the **Close** group, select the **Close &amp; Apply** icon.
...
78. In Power BI Desktop, when the queries have been applied, at the bottom-left corner in the status bar, notice that the model storage mode is DirectQuery.
...
2. Go to the resource group and locate the SQL pool named **sqldb<inject key="DeploymentID" enableCopy="false"/>**.
