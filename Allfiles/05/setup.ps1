...
$resourceGroupName = (Get-AzResourceGroup | Where-Object { $_.ResourceGroupName -like "lab05-rg*" }).ResourceGroupName
...
(Get-Content -Path "C:\LabFiles\DP-500-Azure-Data-Analyst\Allfiles\05\parameters.json") | ForEach-Object {$_ -Replace "GET-DEPLOYMENT-ID", "$DeploymentID"} | Set-Content -Path "C:\LabFiles\DP-500-Azure-Data-Analyst\Allfiles\05\parameters.json"
